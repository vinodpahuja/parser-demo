  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$bytecode = [
          ...
          peg$decode("%;~/\xBF#;\u01AF/\xB6$;\xAC/\xAD$;\u01AF/\xA4$;\u012E/\x9B$;\u01AF/\x92$;5/\x89$;\u01AF/\x80$;\xA7.\" &\"/r$;\u01AF/i$;\xB5.\" &\"/[$;\u01AF/R$;\xC3.\" &\"/D$;\u01AF/;$;\xC7.\" &\"/-$8/:\"/&,(&$\" )(/'#(.'#(-'#(,'#(+'#(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"),
          peg$decode("%;\x80/\x9F#;\u01AF/\x96$;\xAC.\" &\"/\x88$;\u01AF/\x7F$;\xA7.\" &\"/q$;\u01AF/h$;\xB5.\" &\"/Z$;\u01AF/Q$;\xC3.\" &\"/C$;\u01AF/:$;\xC7.\" &\"/,$8+:#+%(&$\" )(+'#(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"),
          peg$decode("%;7/\xCC#;\u01AF/\xC3$;\u012C.\" &\"/\xB5$;\u01AF/\xAC$;\xB3/\xA3$;\u01AF/\x9A$;8.\" &\"/\x8C$;\u01AF/\x83$;\u01A5/z$;\u01AF/q$;\xEB/h$;\u01AF/_$;\u01A6/V$;\u01AF/M$;9/D$;\u01AF/;$;:.\" &\"/-$81:$1&0,*&\" )(1'#(0'#(/'#(.'#(-'#(,'#(+'#(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"),
          peg$decode("%;7/\x95#;\u01AF/\x8C$;\u012C.\" &\"/~$;\u01AF/u$;\xB3/l$;\u01AF/c$;8.\" &\"/U$;\u01AF/L$;9/C$;\u01AF/:$;:.\" &\"/,$8+:%+%*&$\" )(+'#(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"),
          peg$decode("%;7/\xA7#;\u01AF/\x9E$;\u012C.\" &\"/\x90$;\u01AF/\x87$;\xB3/~$;\u01AF/u$;8.\" &\"/g$;\u01AF/^$;\u012E/U$;\u01AF/L$;5/C$;\u01AF/:$;:.\" &\"/,$8-:&-%,(&\" )(-'#(,'#(+'#(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"),
